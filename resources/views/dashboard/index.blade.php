...
{{-- 1. Mengisi Header Layout Utama secara dinamis --}}
...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        {{-- Pastikan component x-stat Anda sudah support styling modern --}}
        <x-stat title="Total User" value="20" icon="group" color="bg-blue-50 text-blue-600" />
        <x-stat title="Total Mekanik" value="12" icon="engineering" color="bg-orange-50 text-orange-600" />
        <x-stat title="Total Pengawas" value="8" icon="visibility" color="bg-purple-50 text-purple-600" />
        <x-stat title="Laporan Arsip" value="1,240" icon="folder" color="bg-emerald-50 text-emerald-600" />
    </div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-sm text-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 border-b border-gray-100 last:border-b-0 bg-surface-alt">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center gap-3">
                                <button class="text-gray-400 hover:text-indigo-600 transition" title="Edit">
                                    <span class="material-symbols-outlined text-[20px]">edit_square</span>
                                </button>
                                <button class="text-gray-400 hover:text-red-500 transition" title="Hapus">
                                    <span class="material-symbols-outlined text-[20px]">delete</span>
