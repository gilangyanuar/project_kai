...
@section('content')
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-8 relative">
        ...
        <h2 class="text-lg font-bold text-gray-900 mb-6">Tool Box - Informasi Pemeriksaan</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                ...
                <div class="md:col-span-3">
                    <input type="text" value="12039" readonly 
                           class="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-sm text-gray-600 focus:outline-none">
                </div>
            </div>
        ...
        <div class="mt-8 flex justify-end">
            <a href="{{ route('master.toolbox.pemeriksaan') }}" 
