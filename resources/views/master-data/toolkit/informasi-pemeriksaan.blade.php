...
@section('content')
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-8 relative">
        
        <h2 class="text-lg font-bold text-gray-900 mb-6">Tool Kit - Informasi Pemeriksaan</h2>

        <form action="#" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                <label class="font-bold text-gray-800">Master ID</label>
                <div class="md:col-span-3">
                    <input type="text" value="12039" readonly class="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-sm text-gray-600 focus:outline-none">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                ...
                <div class="md:col-span-3">
                    <input type="text" value="KA - 120" readonly class="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-sm text-gray-600 focus:outline-none">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                ...
                <div class="md:col-span-3">
                    <input type="text" value="22 November 2025" readonly class="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-sm text-gray-600 focus:outline-none">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-start gap-4" x-data="{ open: false, selected: 'Draft' }">
                ...
                <div class="md:col-span-3 relative">
                    ...
                    <div x-show="open" @click.outside="open = false" 
                         ...
                         style="display: none;"> <div class="p-2 space-y-1">
                            <div @click="selected = 'Draft'; open = false" class="flex items-center gap-3 p-2 hover:bg-gray-50 cursor-pointer rounded-md">
                                <div class="w-5 h-5 border border-gray-300 rounded flex items-center justify-center" 
                                     :class="selected === 'Draft' ? 'bg-kain-navy border-kain-navy' : ''">
                            ...
                            <div @click="selected = 'Pending'; open = false" class="flex items-center gap-3 p-2 hover:bg-gray-50 cursor-pointer rounded-md">
                                <div class="w-5 h-5 border border-gray-300 rounded flex items-center justify-center"
                                     :class="selected === 'Pending' ? 'bg-kain-navy border-kain-navy' : ''">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                ...
                <div class="md:col-span-3">
                    <input type="text" value="Ali" readonly class="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-sm text-gray-600 focus:outline-none">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                ...
                <div class="md:col-span-3">
                    <input type="text" value="Amir" readonly class="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-sm text-gray-600 focus:outline-none">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-start gap-4">
                ...
                <div class="md:col-span-3">
                    <textarea rows="3" class="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-sm text-gray-800 focus:outline-none focus:ring-1 focus:ring-blue-500"></textarea>
                </div>
            </div>
        ...
        <div class="mt-8 flex justify-end">
            <a href="{{ route('master.toolkit.pemeriksaan') }}" 
